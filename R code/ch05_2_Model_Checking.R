...
setwd("~/01_LECTURE/14 범주형자료분석/실습 R")
...
## Section 5.2.4: Residuals for Logit Models
rstandard(obj.M) # standardized residuals for AZT data. Note that a residual is uninformative for ungrouped binary data, 
